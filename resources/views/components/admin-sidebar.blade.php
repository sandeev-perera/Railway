...
<ul>
    ...
    @if ($roleID < 2)
        ...
        <li class="p-4 hover:bg-[#189AB4]"><a href="" class="sidebar-link block" data-page="ticket-validator">Validate Tickets</a></li>
    @endif
    ...
    @if (in_array($roleID, [12, 13]))
        <li class="p-4 hover:bg-[#189AB4]"><a href="" class="sidebar-link block" data-page="ticket-validator">Validate Ticket</a></li>
    @endif
